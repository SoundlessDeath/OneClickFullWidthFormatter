...
class OutputDirDialog(QtWidgets.QDialog):
    ...
    def _setup_ui(self):
        ...
        self.quick_combo.setMinimumWidth(100)
        self.quick_combo.setMaximumWidth(140)
    ...
    def open_out_dir(self):
        ...
        try:
            ...
            if self.converted_outputs:
                # Use the first file for the /select parameter, then add others
                ...
                if len(self.converted_outputs) == 1:
                    ...
                    import subprocess
                    # Build command to select multiple files
                    file_list = ','.join(f'"{str(f)}"' for f in self.converted_outputs)
